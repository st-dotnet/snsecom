...
SNS.namespace("Local").Doit = (function () {
...
SNS.namespace("Utils").Alert = (function () {
...
SNS.namespace("Utils").Delete = (function () {
...
SNS.namespace("Utils").Misc = (function () {
...
SNS.namespace("Utils").Import = (function () {
...
SNS.namespace("Utils").Typeahead = (function () {
...
$(function () {
    ...
    SNS.Utils.Alert.start();
    SNS.Utils.Misc.start();
    SNS.Utils.Delete.start();
    SNS.Utils.Typeahead.start();
